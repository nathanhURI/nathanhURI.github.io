...
function generateScroll(array){
  for(var i=0; i<array.length; i++){
    ...
    image = "<img class=' icon img-fluid' src=" +array[i].imagepath + array[i].value + "_1.png alt="+ array[i].name +" Icon></a>";
...
function generateDescImg(array){
  ...
  for(var j=1; j<=array[pos].imagenum; j++){
    $("#blueprint-info").append("<img id='item-image' class='img-fluid button-img' src='" + array[pos].imagepath + array[pos].value + "_"+j+".png' alt="+ array[pos].name + j +" Image></a>");
  }
