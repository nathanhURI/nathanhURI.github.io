...
function generateScroll(array){
  for(var i=0; i<array.length; i++){
    ...
    image = "<img class=' icon img-fluid' src=" +array[i].imagepath + array[i].value + ".jpg alt="+ array[i].name +" Icon></a>";
...
function generateDescImg(array){
  ...
  $("#item-image").attr("src",array[pos].imagepath + array[pos].value + ".jpg")
